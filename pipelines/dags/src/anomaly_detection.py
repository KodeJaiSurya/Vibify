...
if __name__ == '__main__':
    import sys
    # data_dir = sys.argv[1] if len(sys.argv) > 1 else os.path.abspath('./pipelines/dags/data') '/Vibify/data'
    base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
    data_dir = sys.argv[1] if len(sys.argv) > 1 else os.path.join(base_dir, 'Vibify', 'data')
