...
load_song_data_task = PythonOperator(
    ...
    dag=dag,
    op_args=['us-east1-vibeoncloud-89c595e0-bucket', 'data/raw/spotify/genres_v2.csv'],
)
...
save_song_data_task = PythonOperator(
    ...
    dag=dag,
    op_args=[scale_song_data_task.output, 'us-east1-vibeoncloud-89c595e0-bucket', 'data/preprocessed/spotify/genres_v2.csv'],
)
...
download_emotion_data_task = PythonOperator(
    ...
    dag=dag,
    op_args=['us-east1-vibeoncloud-89c595e0-bucket', 'data/raw/facial_expression/fer2013.csv'],
    )
...
process_emotion_data_task = PythonOperator(
    ...
    dag=dag,
    op_args=[download_emotion_data_task.output, 'us-east1-vibeoncloud-89c595e0-bucket', 1000],
)

aggregate_filtered_data_task = PythonOperator(
    task_id="aggregate_filtered_data_task",
    python_callable=aggregate_filtered_data,
    op_args=[process_emotion_data_task.output, 'us-east1-vibeoncloud-89c595e0-bucket'],
    dag=dag,
)
